...
import { optionStars, optionCategoryAppliances, optionSale } from "../../utils/dropdown";
          ...
          {getData.map((e, index) => (
            ...
            >
              <div className="w-full text-end">
                <button onClick={()=> handleDelete(e.product.id)} className="px-3 py-1 bg-emerald-100 text-red-400 rounded-lg">
                  Remove
                </button>
              </div>
              <img
